...
<html ⚡>
  ...
  <body>
    ...
    <amp-story standalone
        ...
        publisher-logo-src="{{asset('frontend')}}/assets/AMP-Brand-White-Icon.svg"
        poster-portrait-src="{{asset('frontend')}}/assets/cover.jpg">
      <amp-story-page id="cover">
        <amp-story-grid-layer template="fill">
          <amp-img src="{{asset('frontend')}}/assets/cover.jpg"
      ...
      <amp-story-page id="page1">
        <amp-story-grid-layer template="vertical">
          <h1>Cats</h1>
          <amp-img src="{{asset('frontend')}}/assets/cat.jpg"
              width="720" height="1280"
              layout="responsive">
          </amp-img>
      ...
      <amp-story-page id="page2">
        <amp-story-grid-layer template="fill">
          <amp-img src="{{asset('frontend')}}/assets/dog.jpg" 
              width="720" height="1280"
              layout="responsive">
          </amp-img>
        </amp-story-grid-layer>
      ...
      <amp-story-page id="page3" background-audio="{{asset('frontend')}}/assets/bird-singing.mp3">
        <amp-story-grid-layer template="fill">
          <amp-img src="{{asset('frontend')}}/assets/bird.jpg"
              width="720" height="1280"
              layout="responsive">
          </amp-img>
        </amp-story-grid-layer>
      ...
      <amp-story-page id="page4">
        <amp-story-grid-layer template="fill">
          <amp-video autoplay loop
                width="720" height="1280"
                poster="{{asset('frontend')}}/assets/rabbit.jpg"
                layout="responsive">
              <source src="{{asset('frontend')}}/assets/rabbit.mp4" type="video/mp4">
          </amp-video>
        </amp-story-grid-layer>
        <amp-story-grid-layer template="vertical">
          <h1>Rabbits</h1>
      ...
      <amp-story-page id="page5">
        <amp-story-grid-layer template="vertical" class="noedge">
          <div class="wrapper">
            ...
            <amp-img src="{{asset('frontend')}}/assets/rabbit.jpg"
                width="720" height="1280"
                layout="responsive"
                animate-in="fade-in"
                animate-in-delay="1s">
