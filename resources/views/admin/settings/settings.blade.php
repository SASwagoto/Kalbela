...
@endcomponent
    <section class="w-full">
        <form action="" method="POST" enctype="multipart/form-data" class="w-full flex justify-start gap-10">
            @csrf
            @method('PUT')
            <div class="w-2/4 flex flex-col gap-4 border rounded-md p-2">
                <div class="flex justify-start gap-2">
                    ...
                    <div class="w-5/6 flex items-center">
                        <input type="text" class="form-input rounded-md" name="site_title">
                    </div>
                </div>
                <div class="flex justify-start gap-2">
                    <div class="w-1/6 flex items-center justify-start">
                    ...
                    <div class="w-5/6 flex items-center">
                        <input type="text" class="form-input rounded-md" name="email">
                    </div>
                </div>
                <div class="flex justify-start gap-2">
                    <div class="w-1/6 flex items-center justify-start">
                    ...
                    <div class="w-5/6 flex items-center">
                        <input type="text" class="form-input rounded-md" name="adv_email">
                    </div>
                </div>
                <div class="flex justify-start gap-2">
                    <div class="w-1/6 flex items-center justify-start">
                    ...
                    <div class="w-5/6 flex gap-2 items-center">
                        <div class="w-1/2">
                            <input type="text" class="form-input rounded-md" name="phone_a">
                        </div>
                        <div class="w-1/2">
                            <input type="text" class="form-input rounded-md" name="phone_b">
                        </div>
                    </div>
                </div>
                <div class="flex justify-start gap-2">
                    ...
                    <div class="w-5/6 flex gap-2 items-center">
                        <div class="w-1/2">
                            <input type="text" class="form-input rounded-md" name="adv_phone_a">
                        </div>
                        <div class="w-1/2">
                            <input type="text" class="form-input rounded-md" name="adv_phone_b">
                        </div>
                    </div>
                </div>
                <div class="flex justify-start gap-2">
                    ...
                    <div class="w-5/6 flex gap-2 items-center">
                        <div class="w-1/2">
                            <input type="text" class="form-input rounded-md" name="mobile_a">
                        </div>
                        <div class="w-1/2">
                            <input type="text" class="form-input rounded-md" name="mobile_b">
                        </div>
                    </div>
                </div>
                <div class="flex justify-start gap-2">
                    ...
                    <div class="w-5/6 flex gap-2 items-center">
                        <div class="w-1/2">
                            <input type="text" class="form-input rounded-md" name="adv_mobile_a">
                        </div>
                        <div class="w-1/2">
                            <input type="text" class="form-input rounded-md" name="adv_mobile_b">
                        </div>
                    </div>
                </div>
                <div class="flex justify-start gap-2">
                    ...
                    <div class="w-5/6 flex gap-2 items-center">
                        <div class="w-1/2">
                            <input type="text" class="form-input rounded-md" name="fax_a">
                        </div>
                        <div class="w-1/2">
                            <input type="text" class="form-input rounded-md" name="fax_b">
                        </div>
                    </div>
                </div>
                <div class="flex justify-start gap-2">
                    ...
                    <div class="w-5/6 flex items-center">
                        <input type="text" class="form-input rounded-md" name="address">
                    </div>
                </div>
                <div class="flex justify-start gap-2">
                    <div class="w-1/6 flex items-center justify-start">
                    ...
                    <div class="w-5/6 flex items-center">
                        <input type="text" class="form-input rounded-md" name="copyright_text">
                    </div>
                </div>
                <div class="flex justify-start gap-2">
                    <div class="w-1/6 flex items-center justify-start">
                    ...
                    <div class="w-5/6 flex items-center">
                        <input type="text" class="form-input rounded-md" name="footer_credit">
                    </div>
                </div>
            </div>
            <div class="w-2/4 flex flex-col gap-4 border rounded-md p-2">
                ...
                <div class="flex justify-start gap-2">
                    ...
                    <div class="w-5/6 flex items-center">
                        <input type="text" class="form-input rounded-md" name="fb_links">
                    </div>
                </div>
                <div class="flex justify-start gap-2">
                    <div class="w-1/6 flex items-center justify-start">
                    ...
                    <div class="w-5/6 flex items-center">
                        <input type="text" class="form-input rounded-md" name="yt_links">
                    </div>
                </div>
                <div class="flex justify-start gap-2">
                    <div class="w-1/6 flex items-center justify-start">
                    ...
                    <div class="w-5/6 flex items-center">
                        <input type="text" class="form-input rounded-md" name="ln_links">
                    </div>
                </div>
                <div class="flex justify-start gap-2">
                    <div class="w-1/6 flex items-center justify-start">
                    ...
                    <div class="w-5/6 flex items-center">
                        <input type="text" class="form-input rounded-md" name="x_links">
                    </div>
                </div>
                <div class="flex justify-start gap-2">
                    <div class="w-1/6 flex items-center justify-start">
                    ...
                    <div class="w-5/6 flex items-center">
                        <input type="text" class="form-input rounded-md" name="inst_links">
                    </div>
                </div>
                <div class="flex justify-start gap-2">
